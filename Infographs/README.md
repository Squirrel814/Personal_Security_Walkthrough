# Infographs — Personal Security Walkthrough

Parchment-style visual guides for the repo. **Style reference:** `Investigation-Flow.jpg` and `Personal-Security-Walkthrough.jpg` only.

**Image prompts:** [VISUAL-PROMPTS_v2.md](VISUAL-PROMPTS_v2.md)  
**Mascot assignments:** `Agents-Designs-Ideas/Interwoven_Field-Team_Mascot-Assignment_Plan_v1.0.md` (v1.2)  
**Do not use** `Archived/` images as style targets for new work.
...
Use **factual investigation vocabulary** only — no game or Acorn Grove terms. See VISUAL-PROMPTS_v2.md § Language rules.